    ...
    <div className="page__content">
      ...
      <div className="guide__para">
          ...
          <ul>
            ...
            <li>💳 Credit when credit is due</li>
            <ul className="sub__list"><br></br>
          ...
          <h4>❌ Don't</h4><hr></hr>
          <ul>
            <li>💬 Abuse hicathon's branding</li>
            <ul className="sub__list"><br></br>
          ...
          <h3>📁 Asset Downloads (Click)</h3><hr></hr>
